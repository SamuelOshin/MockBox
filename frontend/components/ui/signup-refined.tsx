...
interface ThemeAwareSignUpProps {
  ...
  onGoogleSignIn?: () => void;
  onGitHubSignIn?: () => void;
  onEmailSignUp?: (data: SignUpFormData) => void;
  isLoading?: boolean;
...
export function ThemeAwareSignUp({
    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="flex flex-1 flex-col justify-center px-4 py-10 lg:px-6">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          {(onGoogleSignIn || onGitHubSignIn) && onEmailSignUp && (
          ...
          {onEmailSignUp && (
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="terms-signup" className="text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  I agree to the{" "}
...
export default ThemeAwareSignUp;
