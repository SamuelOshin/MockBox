...
class TestCreateMock:
    ...
    @pytest.mark.asyncio
    async def test_create_mock_success(self, mock_service, sample_user_id, sample_mock_create, sample_mock_data):
    ...
    @pytest.mark.asyncio
    async def test_create_mock_duplicate_endpoint(self, mock_service, sample_user_id, sample_mock_create, sample_mock_data):
    ...
    @pytest.mark.asyncio
    async def test_create_mock_foreign_key_error(self, mock_service, sample_user_id, sample_mock_create):
    ...
    @pytest.mark.asyncio
    async def test_create_mock_database_error(self, mock_service, sample_user_id, sample_mock_create):
        """Test create mock with general database error"""
        # Mock dependencies
        mock_service._get_mock_by_endpoint = AsyncMock(return_value=None)
        
        # Mock database error
        mock_service.client.table.return_value.insert.return_value.execute.side_effect = Exception("Database error")
    ...
    @pytest.mark.asyncio
    async def test_create_mock_no_data_returned(self, mock_service, sample_user_id, sample_mock_create):
...
class TestGetMock:
    ...
    @pytest.mark.asyncio
    async def test_get_mock_with_user_id(self, mock_service, sample_mock_id, sample_user_id, sample_mock_data):
        """Test getting mock with user ID"""
        # Mock database response
        mock_result = Mock()
        mock_result.data = [sample_mock_data]
        mock_service.client.table.return_value.select.return_value.eq.return_value.or_.return_value.execute.return_value = mock_result
    ...
    @pytest.mark.asyncio
    async def test_get_mock_public_only(self, mock_service, sample_mock_id, sample_mock_data):
        """Test getting mock without user ID (public only)"""
        # Mock database response
        mock_result = Mock()
        mock_result.data = [sample_mock_data]
        mock_service.client.table.return_value.select.return_value.eq.return_value.eq.return_value.execute.return_value = mock_result
    ...
    async def test_get_mock_database_error(self, mock_service, sample_mock_id):
        ...
        # Mock database error
        mock_service.client.table.return_value.select.side_effect = Exception("Database error")
...
class TestListMocks:
    ...
    @pytest.mark.asyncio
    async def test_list_mocks_basic(self, mock_service, sample_user_id, sample_mock_data):
    ...
    @pytest.mark.asyncio
    async def test_list_mocks_with_filters(self, mock_service, sample_user_id, sample_mock_data):
...
class TestUpdateMock:
    ...
    @pytest.mark.asyncio
    async def test_update_mock_success(self, mock_service, sample_mock_id, sample_user_id, sample_mock_data):
        ...
        mock_service.client.table.return_value.update.return_value.eq.return_value.execute.return_value = mock_result
        
        # Execute
        result = await mock_service.update_mock(sample_mock_id, sample_user_id, update_data)
    ...
    @pytest.mark.asyncio
    async def test_update_mock_not_found(self, mock_service, sample_mock_id, sample_user_id):
    ...
    @pytest.mark.asyncio
    async def test_update_mock_wrong_user(self, mock_service, sample_mock_id, sample_user_id, sample_mock_data):
...
class TestDeleteMock:
    ...
    @pytest.mark.asyncio
    async def test_delete_mock_success(self, mock_service, sample_mock_id, sample_user_id, sample_mock_data):
    ...
    @pytest.mark.asyncio
    async def test_delete_mock_not_found(self, mock_service, sample_mock_id, sample_user_id):
...
class TestSimulateMock:
    ...
    @pytest.mark.asyncio
    async def test_simulate_mock_success(self, mock_service, sample_mock_id, sample_mock_data):
    ...
    @pytest.mark.asyncio
    async def test_simulate_mock_inactive(self, mock_service, sample_mock_id, sample_mock_data):
    ...
    @pytest.mark.asyncio
    async def test_simulate_mock_with_delay(self, mock_service, sample_mock_id, sample_mock_data):
...
class TestGetMockByEndpoint:
    ...
    async def test_get_mock_by_endpoint_not_found(self, mock_service):
        ...
        # Execute
        result = await mock_service.get_mock_by_endpoint("/api/nonexistent", HTTPMethod.GET)
...
class TestPrivateMethods:
    ...
    @pytest.mark.asyncio
    async def test_get_mock_by_endpoint_private(self, mock_service, sample_user_id, sample_mock_data):
        ...
        # Execute
        result = await mock_service._get_mock_by_endpoint(sample_user_id, "/api/test", HTTPMethod.GET)
        
        # Assertions
        assert isinstance(result, MockModel)
    
    @pytest.mark.asyncio
    async def test_create_mock_stats(self, mock_service, sample_mock_id, sample_user_id):
    ...
    @pytest.mark.asyncio
    async def test_create_mock_stats_exception(self, mock_service, sample_mock_id, sample_user_id):
        """Test _create_mock_stats method with exception"""
        # Mock database error
        mock_service.client.table.return_value.insert.side_effect = Exception("Database error")
    ...
    async def test_log_mock_access(self, mock_service, sample_mock_id, sample_user_id):
        ...
        # Execute (should not raise exception)
        await mock_service._log_mock_access(sample_mock_id, sample_user_id, request_data, 100.0, 200)
