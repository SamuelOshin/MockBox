...
class CustomRateLimiter:
    ...
    async def get_rate_limit_key(self, request: Request, endpoint_type: str = "default") -> str:
...
RATE_LIMITS = {
    ...
    "public_api": {"limit": 100, "window": 60},  # 100 requests per minute for public API
    "authenticated": {"limit": 1000, "window": 60},  # 1000 requests per minute for authenticated users
    "anonymous": {"limit": 60, "window": 60},  # 60 requests per minute for anonymous users
