...
from app.schemas.ai_schemas import (
    MockGenerationRequest, MockGenerationResponse, AIErrorResponse
)
...
@router.post("/generate", response_model=MockGenerationResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/generate-and-save", response_model=MockResponse, status_code=status.HTTP_201_CREATED)
    ...
    **Benefits:**
    ...
    try:
        ...
        mock_data = MockCreate(
            ...
            description=description or f"AI generated mock for {request.endpoint}. {ai_result.explanation}",
        ...
        error_details = [{"field": error["loc"][-1], "message": error["msg"]} for error in e.errors()]
        raise HTTPException(
